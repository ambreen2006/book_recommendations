...
class BooksDataLoader(object):
    ...
    def __init__(self, readers_path='../Data/goodbooks-10k/ratings.csv',
        ...
        self.readers_path = readers_path
        self.books_meta_data_path = books_meta_data_path
        self.genre_similarity_matrix_path = genre_similarity_matrix_path
